Create a lock directory that didn't originally exist
  ...
  10 |  (url "git+file:///Users/samoht/git/dune/_build/.sandbox/263b44de221574447ae76fc530b515e6/default/test/blackbox-tests/test-cases/pkg/lock-directory-regeneration-safety.t/mock-opam-repository"))
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  Error: Failed to run external command:
  'git ls-remote "file:///Users/samoht/git/dune/_build/.sandbox/263b44de221574447ae76fc530b515e6/default/test/blackbox-tests/test-cases/pkg/lock-directory-regeneration-safety.t/mock-opam-repository"'
  Hint: Check that this Git URL in the project configuration is correct:
  "file:///Users/samoht/git/dune/_build/.sandbox/263b44de221574447ae76fc530b515e6/default/test/blackbox-tests/test-cases/pkg/lock-directory-regeneration-safety.t/mock-opam-repository"
  [1]
...
Attempt to create a lock directory inside an existing directory without a lock.dune file
  ...
  cp: dir-without-metadata: No such file or directory
  [1]
  $ dune_pkg_lock_normalized --format=directory
  fatal: '$TESTCASE_ROOT/mock-opam-repository' does not appear to be a git repository
  fatal: Could not read from remote repository.
...
Attempt to create a lock directory inside an existing directory with an invalid lock.dune file
  ...
  cp: dir-with-invalid-metadata: No such file or directory
  [1]
  $ dune_pkg_lock_normalized --format=directory
  fatal: '$TESTCASE_ROOT/mock-opam-repository' does not appear to be a git repository
  fatal: Could not read from remote repository.
