...
Generate a mock opam repository
  ...
  6 |  (url "git+file:///Users/samoht/git/dune/_build/.sandbox/a42697ca28111347be632d29a01199de/default/test/blackbox-tests/test-cases/pkg/mock-opam-repository"))
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  Error: Failed to run external command:
  'git ls-remote "file:///Users/samoht/git/dune/_build/.sandbox/a42697ca28111347be632d29a01199de/default/test/blackbox-tests/test-cases/pkg/mock-opam-repository"'
  Hint: Check that this Git URL in the project configuration is correct:
  "file:///Users/samoht/git/dune/_build/.sandbox/a42697ca28111347be632d29a01199de/default/test/blackbox-tests/test-cases/pkg/mock-opam-repository"
