...
Run the solver and generate a lock directory.
  ...
  6 |  (url "git+file:///Users/samoht/git/dune/_build/.sandbox/722f47b9279267d6a18f9d89d38f6785/default/test/blackbox-tests/test-cases/pkg/lockfile-generation.t/mock-opam-repository"))
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  Error: Failed to run external command:
  'git ls-remote "file:///Users/samoht/git/dune/_build/.sandbox/722f47b9279267d6a18f9d89d38f6785/default/test/blackbox-tests/test-cases/pkg/lockfile-generation.t/mock-opam-repository"'
  Hint: Check that this Git URL in the project configuration is correct:
  "file:///Users/samoht/git/dune/_build/.sandbox/722f47b9279267d6a18f9d89d38f6785/default/test/blackbox-tests/test-cases/pkg/lockfile-generation.t/mock-opam-repository"
  [1]
